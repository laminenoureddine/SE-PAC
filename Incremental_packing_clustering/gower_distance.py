...
# Code function has been downloaded frpm here: https://sourceforge.net/projects/gower-distance-4python/files/
# Then concerted from Jupiter to python
...
def gower_distances(X, Y=None, feature_weight=None, categorical_features=None):
    ...
    for i in range(n_rows):
        ...
        # for non square results_with_synthetic_centroids
        if n_rows != y_n_rows:
            j_start = 0
