...
min_max_scaler_min = "../scaler_values/min_max_scaler_min_" + str(sys.argv[1]) + ".npy"
np.save(min_max_scaler_min, min_max_scaler.data_min_)
min_max_scaler_max = "../scaler_values/min_max_scaler_max_" + str(sys.argv[1]) + ".npy"
np.save(min_max_scaler_max, min_max_scaler.data_max_)
min_max_scaler_scale = "../scaler_values/min_max_scaler_scale_" + str(sys.argv[1]) + ".npy"
np.save(min_max_scaler_scale, min_max_scaler.scale_)
...
matrix_long_name_path = '../distance_matrices/offline_manhattan_distance_matrix_'+ sys.argv[1] + '.npy'
np.save(matrix_long_name_path, manhattan_distance_matrix)
